...
def _get_model_analysis_input(cfg, use_train_input):
    ...
    if use_train_input:
        ...
        #     2,
        #     cfg.process_frame_nums if cfg.use_sal else cfg.fps,
        #     1,
        #     144,
        #     256,
        # )
        ...
        sal = torch.rand(
            4,
            cfg.process_frame_nums,
            144,
            256,
        )
        # input_tensors = (head, sal)
    else:
        # input_tensors = torch.rand(
        #     rgb_dimension,
    ...
    # model_inputs = input_tensors
    if cfg.NUM_GPUS:
        model_inputs = (head.cuda(non_blocking=True), sal.cuda(non_blocking=True))
