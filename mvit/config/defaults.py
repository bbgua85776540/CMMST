...
# Dataset.
# _C.TRAIN.DATASET = "vrdataset_only_traj"
_C.TRAIN.DATASET = "vrdataset"
...
_C.MVIT.SAL_POOL_KV_STRIDE = None
...
_C.MVIT.SAL_POOL_KV_STRIDE_ADAPTIVE = None

# Stride size for the Pool Q at layer i.
# Format: [[i, stride_t_i, stride_h_i, stride_w_i], ...,]
_C.MVIT.POOL_Q_STRIDE = []

_C.MVIT.POOL_T_STRIDE = []

_C.MVIT.SAL_POOL_Q_STRIDE = []

# Kernel size for Q, K, V pooling.
_C.MVIT.POOL_KVQ_KERNEL = (3, 3)
_C.MVIT.SAL_POOL_KVQ_KERNEL = (3, 3)
...
_C.DATA.PATH_TO_DATA_DIR = "/media/kemove/1A226EEF226ECEF7/work/pytorch_workplace/CMMST/path/to/imagenet-1k/"
...
_C.MVIT.EMBED_DIM = 72
_C.process_frame_nums = 60
_C.fps_stride = 5
_C.fps = 30
_C.resume = None
# _C.resume = 'F:/mvit-result/186/CMMST/result/model/mvit-b8-pre30-lr000005-gblur49-epoch6-ls0.0032265205747534025.pth'

_C.use_sal = True
# _C.attention_type = 'divided_space_time'
_C.attention_type = 'joint'
